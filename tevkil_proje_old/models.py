...
class User(UserMixin, db.Model):
    ...
    is_verified = db.Column(db.Boolean, default=False)  # Kullanıcı doğrulama durumu (admin onayı)
...
class Message(db.Model):
    ...
    # Status
    delivered_at = db.Column(db.DateTime, default=lambda: datetime.now(timezone.utc))  # Karşı tarafa ulaştı
